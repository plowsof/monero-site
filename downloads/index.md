            ...
            <div class="info-block">
                <h2 id="mobilelight">{% t downloads.mobilelight %}</h2>
                    <div class="row">
                        ...
                        <tr>
                            <td><img class="small" src="/img/monfluo.png" width="100" height="100" loading="lazy" alt="Monfluo logo"><a href="https://codeberg.org/acx/monfluo/releases/latest">Monfluo</a></td>
                            <td><span class="icon-android"></span></td>
                            <td>X</td>
                        ...
                        <tr>
                            <td><img class="small" src="/img/unstoppable-wallet.png" width="100" height="100" loading="lazy" alt="Unstoppable Wallet logo"><a href="https://unstoppable.money/">Unstoppable</a></td>
                            <td><span class="icon-android"></span><span class="icon-apple"></span></td>
                            <td>X</td>
