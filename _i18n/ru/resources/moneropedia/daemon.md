...
RPC. См. [руководство по интерфейсу RPC демона]({{ site.docsurl }}/rpc-library/monerod-rpc/)), в котором подробно
...
<sub>1. [Ссылка на страницу monerod на веб-сайте Monero Docs]({{ site.docsurl }}/interacting/monerod-reference/)</sub><br>
